...
function theme_settings_slider()
{
    ...
    <div class="wrap">
                ...
                <div role="tabpanel" class="tab-pane active" id="english">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <p>
                                <small>
                                    <strong>WP itaxxion</strong> Themes is a <strong>Free</strong> Wordpress themes<br/>
                                    <strong>itaxxion</strong> is a Free HTML template owned by <strong><a
                                            href="https://shapebootstrap.net/item/1524962-itaxxion-free-responsive-business-html-template"
                                            target="_blank">shapebootstrap</a>.</strong><br/>
                                    <strong>WP itaxxion</strong> is convertion result of <strong>itaxxion</strong> HTML
                        ...
                        <div class="col-sm-12">
                            ...
                            <p>
                                ...
                                <strong>Once you make a donation please confirm by sending a confirmation email with the
                                    title "Confirm Donation WP itaxxion" to <a href="mailto:dna.extrim@gmail.com">dna.extrim@gmail.com</a></i>
                                </strong>
                                <br/>
                                Thank you :-D
                            </p>
                ...
                <div role="tabpanel" class="tab-pane" id="indonesian">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <p>
                                <small>
                                    <strong>WP itaxxion</strong> Themes merupakan themes Wordpress
                                    <strong>Gratis.</strong><br/>
                                    <strong>itaxxion</strong> merupakan template HTML Gratis milik <strong><a
                                            href="https://shapebootstrap.net/item/1524962-itaxxion-free-responsive-business-html-template"
                                            target="_blank">shapebootstrap</a>.</strong><br/>
                                    <strong>WP itaxxion</strong> merupakan hasil konversi dari <strong>itaxxion</strong>
                        ...
                        <div class="col-sm-12">
                            ...
                            <p>
                                ...
                                <strong><i>Setelah anda melakukan donasi silakan anda melakukan konfirmasi dengan
                                        mengirimkan email konfirmasi dengan judul "Konfirmasi Donasi WP itaxxion" ke <a
        ...
        <h1>itaxxion Slider Settings</h1>
        <form method="post" action="options.php" enctype="multipart/form-data">
            <?php
            settings_fields("section-slider");
            do_settings_sections("itaxxion-slider-settings");
            submit_button();
            ?>
        </form>
    </div>
...
{
    ?>
    <input type="checkbox" name="wp_itaxxion_enable_slider" class="form-control"
           value="1" <?php checked(1, get_option('wp_itaxxion_enable_slider'), true); ?> />
    <?php
}
...
{
    ?>
    <select name="wp_itaxxion_slider_show_on">
        <option value="All" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'All') ? 'selected' : ''; ?>>All
        </option>
        <option
            value="Home Only" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'Home Only') ? 'selected' : ''; ?>>
            Home Only
        </option>
        <option
            value="All Post" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'All Post') ? 'selected' : ''; ?>>
            All Post
        </option>
        <option
            value="All Page" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'All Page') ? 'selected' : ''; ?>>
            All Page
        </option>
        <option
            value="All Category" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'All Category') ? 'selected' : ''; ?>>
            All Category
        </option>
        <option value="All Tag" <?php echo (get_option('wp_itaxxion_slider_show_on') == 'All Tag') ? 'selected' : ''; ?>>
            All Tag
        </option>
    </select>
    <?php
...
function display_theme_slider_fields()
{
    ...
    wp_enqueue_style('itaxxion-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
    // wp_enqueue_style('itaxxion-datatables', get_template_directory_uri().'/css/jquery.dataTables.min.css');
    // wp_enqueue_style('itaxxion-datatables-foundation', get_template_directory_uri().'/css/dataTables.foundation.min.css');
    wp_enqueue_style('itaxxion-datatables-bootstrap', get_template_directory_uri() . '/css/dataTables.bootstrap.min.css');
    wp_enqueue_style('itaxxion-hover', get_template_directory_uri() . '/css/hover-min.css');
    wp_enqueue_style('itaxxion-animate', get_template_directory_uri() . '/css/animate.min.css');
    wp_enqueue_style('itaxxion-hover', get_template_directory_uri() . '/css/hover-min.css');
    wp_enqueue_style('itaxxion-main', get_template_directory_uri() . '/css/main_admin.css');

    wp_enqueue_script('itaxxion-jquery', get_template_directory_uri() . '/js/jquery.js');
    wp_enqueue_script('itaxxion-jquery-ui', get_template_directory_uri() . '/js/jquery-ui.min.js');
    wp_enqueue_script('itaxxion-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js');
    wp_enqueue_script('itaxxion-datatables', get_template_directory_uri() . '/js/jquery.dataTables.min.js');
    wp_enqueue_script('itaxxion-datatables-bootstrap', get_template_directory_uri() . '/js/dataTables.bootstrap.min.js');
    wp_enqueue_script('itaxxion-datatables-ordering', get_template_directory_uri() . '/js/jquery.dataTables.rowReordering.js');
    wp_enqueue_script('itaxxion-bootbox', get_template_directory_uri() . '/js/bootbox.min.js');
    wp_enqueue_script('itaxxion-main', get_template_directory_uri() . '/js/main_admin.js', array(), false, true);
...
{
    add_settings_section("section-slider", "Slider", null, "itaxxion-slider-settings");

    add_settings_field("wp_itaxxion_enable_slider", "Enable slider", "display_enable_slider_element", "itaxxion-slider-settings", "section-slider");
    add_settings_field("wp_itaxxion_slider_show_on", "Slider show on", "display_show_on_element", "itaxxion-slider-settings", "section-slider");

    register_setting("section-slider", "wp_itaxxion_enable_slider");
    register_setting("section-slider", "wp_itaxxion_slider_show_on");
}
...
{
    if (wp_script_is('itaxxion-datatables', 'done')) {
