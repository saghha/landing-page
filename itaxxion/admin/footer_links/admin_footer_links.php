...
{
    /*update_option('wp_itaxxion_footer_links', array(
        'MY PORTFOLIO' => array(
            array(
    ...
    <div class="wrap">
        ...
        <h1>itaxxion Footer Links Settings</h1>
        <div class="row">
            <div class="col-md-4">
                <select name="group" id="group" class="form-control">
                    <?php
                    $footer_links = get_option('wp_itaxxion_footer_links');
...
{
    add_settings_section("section-footer_links", "Footer Links", null, "itaxxion-footer_links-settings");

    add_settings_field("wp_itaxxion_enable_footer_links", "Enable footer_links", "display_enable_footer_links_element", "itaxxion-footer_links-settings", "section-footer_links");
    add_settings_field("wp_itaxxion_footer_links_show_on", "Footer Links show on", "display_show_on_element", "itaxxion-footer_links-settings", "section-footer_links");

    register_setting("section-footer_links", "wp_itaxxion_enable_footer_links");
    register_setting("section-footer_links", "wp_itaxxion_footer_links_show_on");
}
