...
$image = $wpdb->get_row($wpdb->prepare("SELECT * FROM `" . $wpdb->prefix . "wp_itaxxion_portfolio_images` WHERE project_id=%d ORDER BY ordering DESC LIMIT 1", $_POST['project_id_images']));
