...
$images = $wpdb->get_results($wpdb->prepare("SELECT id, ordering FROM `" . $wpdb->prefix . "wp_itaxxion_portfolio_images` WHERE project_id = %d ORDER BY ordering ASC", $_GET['project_id']), object);
$id = $_POST['id'];
