...
--
-- Table structure for table `wp_wp_itaxxion_portfolio`
--

CREATE TABLE IF NOT EXISTS `wp_wp_itaxxion_portfolio` (
...
--
-- Dumping data for table `wp_wp_itaxxion_portfolio`
--

INSERT INTO `wp_wp_itaxxion_portfolio` (`id`, `name`, `published`) VALUES
(1, 'My Portfolio', 1);

-- --------------------------------------------------------

--
-- Table structure for table `wp_wp_itaxxion_portfolio_images`
--

CREATE TABLE IF NOT EXISTS `wp_wp_itaxxion_portfolio_images` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wp_wp_itaxxion_portfolio_images`
--

INSERT INTO `wp_wp_itaxxion_portfolio_images` (`id`, `project_id`, `name`, `description`, `image_url`, `image_path`, `image_type`, `ordering`, `published`) VALUES
(1, 1, 'General Settings', 'Untuk melakukan setting umum pada itaxxion template', 'http://localhost/wordpress2/wp-content/uploads/2016/01/general.jpg', 'C:\\wamp\\www\\wordpress2/wp-content/uploads/2016/01/general.jpg', 'image/jpeg', 1, 1),
...
(19, 2, 'itaxxion Template Kecik Framework Skeleton', 'itaxxion template pada Kecik Framework Skeleton', 'http://localhost/wordpress2/wp-content/uploads/2016/01/itaxxion.jpg', 'C:\\wamp\\www\\wordpress2/wp-content/uploads/2016/01/itaxxion.jpg', 'image/jpeg', 5, 1),
...
--
-- Table structure for table `wp_wp_itaxxion_portfolio_projects`
--

CREATE TABLE IF NOT EXISTS `wp_wp_itaxxion_portfolio_projects` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wp_wp_itaxxion_portfolio_projects`
--

INSERT INTO `wp_wp_itaxxion_portfolio_projects` (`id`, `portfolio_id`, `name`, `description`, `image_url`, `image_path`, `image_type`, `project_url`, `open_new_tab`, `published`, `category`) VALUES
(1, 1, 'WP itaxxion Themes', '<p>Merupakan sebuah template dari hasil konversi Template itaxxion  HTML menjadi versi Template untuk Wordpress dengan beberapa perubahan dan penambahan fitur pada bagian Administrator seperti management untuk slider, portfolio dan footer links</p>', 'http://localhost/wordpress2/wp-content/uploads/2016/01/wp_itaxxion.jpg', 'C:\\wamp\\www\\wordpress2/wp-content/uploads/2016/01/wp_itaxxion.jpg', 'image/jpeg', 'http://donywahyuisp.com', 1, 1, 'Template, Wordpress'),
